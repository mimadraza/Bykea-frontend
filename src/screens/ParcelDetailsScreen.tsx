    ...
    <View style={styles.container}>
      ...
      {current && (
        <Animated.View
          style={[
            styles.riderCard,
            { opacity: fadeAnim, backgroundColor: colors.cardBackground },
          ]}
        >
          ...
          {/* Reject */}
          <TouchableOpacity style={styles.rejectBtn} onPress={rejectRider}>
      ...
      <View style={styles.viewedRow}>
        <AccessibleText style={styles.viewedText}>
          {Math.max(5, 10 - riders.length)} riders have viewed your request
        </AccessibleText>
...
const styles = StyleSheet.create({
  ...
  time: { fontSize: 18, fontWeight: "bold", color: "white" },
  name: { fontSize: 14, opacity: 0.8, marginBottom: 4, color: "white" },

  ratingRow: { flexDirection: "row", alignItems: "center" },
  star: { fontSize: 16, marginRight: 4 },
  rating: { fontSize: 14, color: "white" },
  ...
  viewedText: { color: "white", fontSize: 12 },
  ...
  boxIcon: { width: 65, height: 65, tintColor: "white" },
  ...
  keepText: { color: "black", fontWeight: "bold" },
